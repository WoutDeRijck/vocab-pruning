    ...
    for task in args.tasks:
        ...
        try:
            ...
            log_file = os.path.join(
                task_output_dir, 
                f"{task}_frequency_{suffix}_prune{int(task_params['prune_percent'])}.log"
            )
            ...
            if not os.path.exists(log_file):
                pattern = f"{task}_frequency*prune*.log"
            ...
            if os.path.exists(log_file):
                ...
                pattern_path = os.path.join(task_output_dir, f"{task}_frequency*prune*.log")
